...
public class CLIHelper {
     ...
     */
     public static void CmdHelpHiC() {
        String argument =  "-i path/to/file.hic -c path/to/chrSizeFile.txt -o path/to/output/folder -j path/to/juicerTool.jar ";
    ...
    public static void CmdHelpCool() {
        String argument =  "-i path/to/file.mcool -c path/to/chrSizeFile.txt -o path/to/output/folder -cooltools path/to/cooltools -cooler path/to/cooler";
        String[] argv = argument.split(" ");
    ...
    public static void CmdHelpProcessed(){
        String argument =  "-i path/to/folder/toSIP/ProcessedData -c path/to/chrSizeFile  -o path/to/output/folder ";
        String[] argv = argument.split(" ");
