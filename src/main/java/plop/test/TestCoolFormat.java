...
public class TestCoolFormat {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		//SIPIntra java.plop.sip = new SIPIntra(output, chrSizeFile, gauss, min, max, resolution, saturatedPixel, thresholdMax, diagSize, matrixSize, nbZero,factor,0.03,false,keepTif,cpu);
