...
/////////////////////////////////////////////////////////////////////////		
		...
		label = new JLabel();
		label.setText("Type of java.plop.loops (inter or intra chromosomal):");
		label.setFont(new java.awt.Font("arial",1,12));
		this._container.add(label, new GridBagConstraints(
				0, 2, 0, 0, 0.0, 0.0, GridBagConstraints.NORTHWEST,
	...
	/**
	 * getter of the nb of zero allow around a detected java.plop.loops
	...
	/**
	 * size of the diag, all the java.plop.loops detected inside this size will be removed
	...
	/**
	 * boolean if true start was pushed else keep the java.plop.gui active
	 * @return
	 */
	...
	class RBHicListener implements ActionListener{
		...
		/**
		 * manage the access of the different java.plop.gui element on function of the paramter choose
		 */
	...
	class StartListener implements ActionListener {
		...
		/**
		 * Test all the box, condition etc before to allow the program to run and dispose the java.plop.gui
		 */
		public void actionPerformed(ActionEvent actionEvent){
	...
	class QuitListener implements ActionListener {
		...
		/**
		 * dipose the java.plop.gui and quit the program
		 */
		public void actionPerformed(ActionEvent actionEvent){
			_gui.dispose();
			System.exit(0);
