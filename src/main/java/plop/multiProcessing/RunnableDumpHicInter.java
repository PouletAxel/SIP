 ...
 *
 */
public class RunnableDumpHicInter extends Thread implements Runnable{
    /** path outdir */
    ...
    /** Object HicDumpInter*/
    private HicDumpInter _dumpInter;
    /** bin size*/
     ...
     * @param dumpInterChromosomal  HicDumpInter object dumping the data of interest
     * @param resolution int resolution == size of the bins to dump
     * @param matrixSize int size of the ImagePlus
     */
    public RunnableDumpHicInter(String outputDir, String chr1, int sizeChr1, String chr2, int sizeChr2,
                                HicDumpInter dumpInterChromosomal, int resolution, int matrixSize) {
    ...
    public void run(){
        ...
        System.out.println(file.toString()+" "+file.exists()+" start dump "+_chr1+" size "+_sizeChr1+" "+_chr2+" size "+_sizeChr2+" res "+ nameRes);
