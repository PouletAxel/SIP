...
public class SIPInter  extends SIPObject {
     ...
     * @param thresholdMax threshold value for java.plop.loops detection
     * @param matrixSize image size
     * @param nbZero nb of zero allowed around a loop
     * @param fdr fdr value for the final java.plop.loops filter
     */
    ...
    /**
     * Write detected java.plop.loops after filtering via the fdr value
